      ...
      <section className="grid gap-6 xl:grid-cols-[320px_minmax(0,1fr)]">
        <div className="flex flex-col gap-6" id="summary">
          <Card className="surface-panel">
            <CardHeader>
              ...
              <CardDescription>
                Contact, account, stage, and current commercial value.
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col gap-4">
              ...
              <div className="flex flex-wrap gap-2 text-sm">
                <a
                  ...
                  href={toOfbizUrl(
                    opportunity.backOfficeLinks.contactRecordPath,
                  )}
                  rel="noreferrer"
                  target="_blank"
                >
          ...
          <Card className="surface-panel" id="quote">
            <CardHeader>
              ...
              <CardDescription>
                The salesperson workflow ends once the quote is ready.
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col gap-3">
              {opportunity.quote ? (
                <>
                  ...
                  <div className="surface-muted grid gap-3 p-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="mt-1 font-medium">
                        {formatCurrency(opportunity.quote.total)}
                      </p>
                    </div>
                  </div>
                ...
                <div className="surface-muted p-4 text-sm text-muted-foreground">
                  Save the deal brief first. Quote preparation opens once the
                  customer need is captured.
                </div>
              )}
            </CardContent>
          </Card>
        ...
        <Card className="surface-panel" id="brief">
          <CardHeader>
            ...
            <CardDescription>
              Capture the customer need and item scope that pricing will work
              from.
            </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col gap-4">
            {opportunity.brief?.locked ? (
              <>
                <div className="surface-muted p-4 text-sm text-muted-foreground">
                  This brief is locked because pricing is already prepared for
                  the opportunity.
                </div>
